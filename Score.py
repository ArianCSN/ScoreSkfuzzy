...
precision=0.1
EndTerm = ctrl.Antecedent(np.arange(0, 20.1, precision), "EndTerm")
EndTerm["bad"] = fuzz.trapmf(EndTerm.universe, [0, 3, 7, 10])
EndTerm["normal"] = fuzz.trapmf(EndTerm.universe, [10.01, 11, 13, 14])
EndTerm["good"] = fuzz.trapmf(EndTerm.universe, [14.01, 15, 17, 18])
EndTerm["very good"] = fuzz.trapmf(EndTerm.universe, [18.01, 18.5, 19.5, 20])
MidTerm = ctrl.Antecedent(np.arange(0, 20.1, precision), "MidTerm")
MidTerm["bad"] = fuzz.trapmf(MidTerm.universe, [0, 3, 7, 10])
MidTerm["normal"] = fuzz.trapmf(MidTerm.universe, [10.01, 11, 13, 14])
MidTerm["good"] = fuzz.trapmf(MidTerm.universe, [14.01, 15, 17, 18])
MidTerm["very good"] = fuzz.trapmf(MidTerm.universe, [18.01, 18.5, 19.5, 20])
HomeWorks = ctrl.Antecedent(np.arange(0, 5.1, precision), "HomeWorks")
HomeWorks["lazy"] = fuzz.trapmf(HomeWorks.universe, [0, 1, 1.5, 2])
HomeWorks["normal"] = fuzz.trapmf(HomeWorks.universe, [2.001, 2.2, 3.5, 4])
HomeWorks["hardwork"] = fuzz.trapmf(HomeWorks.universe, [4.001, 4.3, 4.5, 5])
ClassActivity = ctrl.Antecedent(np.arange(0, 100.1, precision), "ClassActivity")
ClassActivity["very lazy"] = fuzz.trapmf(ClassActivity.universe, [0, 7 , 20, 25])
ClassActivity["lazy"] = fuzz.trapmf(ClassActivity.universe, [25.1, 30, 45 , 50])
ClassActivity["normal"] = fuzz.trapmf(ClassActivity.universe, [50.1, 54 , 70, 75])
ClassActivity["hardwork"] = fuzz.trapmf(ClassActivity.universe, [75.1, 80, 92 , 100])
Score = ctrl.Consequent(np.arange(0, 20.1, precision), "Score")
...
rule04 = ctrl.Rule(EndTerm['very good'] & MidTerm["bad"] & HomeWorks["lazy"] & ClassActivity["very lazy"] , Score["F"])
...
rule08 = ctrl.Rule(EndTerm['very good'] & MidTerm["normal"] & HomeWorks["lazy"] & ClassActivity["very lazy"] , Score["D"])
...
rule12 = ctrl.Rule(EndTerm['very good'] & MidTerm["good"] & HomeWorks["lazy"] & ClassActivity["very lazy"] , Score["D"])
rule13 = ctrl.Rule(EndTerm['bad'] & MidTerm["very good"] & HomeWorks["lazy"] & ClassActivity["very lazy"] , Score["F"])
rule14 = ctrl.Rule(EndTerm['normal'] & MidTerm["very good"] & HomeWorks["lazy"] & ClassActivity["very lazy"] , Score["D"])
rule15 = ctrl.Rule(EndTerm['good'] & MidTerm["very good"] & HomeWorks["lazy"] & ClassActivity["very lazy"] , Score["D"])
rule16 = ctrl.Rule(EndTerm['very good'] & MidTerm["very good"] & HomeWorks["lazy"] & ClassActivity["very lazy"] , Score["C"])
...
rule20 = ctrl.Rule(EndTerm['very good'] & MidTerm["bad"] & HomeWorks["normal"] & ClassActivity["very lazy"] , Score["D"])
...
rule24 = ctrl.Rule(EndTerm['very good'] & MidTerm["normal"] & HomeWorks["normal"] & ClassActivity["very lazy"] , Score["D"])
...
rule28 = ctrl.Rule(EndTerm['very good'] & MidTerm["good"] & HomeWorks["normal"] & ClassActivity["very lazy"] , Score["C"])
rule29 = ctrl.Rule(EndTerm['bad'] & MidTerm["very good"] & HomeWorks["normal"] & ClassActivity["very lazy"] , Score["D"])
rule30 = ctrl.Rule(EndTerm['normal'] & MidTerm["very good"] & HomeWorks["normal"] & ClassActivity["very lazy"] , Score["D"])
rule31 = ctrl.Rule(EndTerm['good'] & MidTerm["very good"] & HomeWorks["normal"] & ClassActivity["very lazy"] , Score["C"])
rule32 = ctrl.Rule(EndTerm['very good'] & MidTerm["very good"] & HomeWorks["normal"] & ClassActivity["very lazy"] , Score["C"])
...
rule36 = ctrl.Rule(EndTerm['very good'] & MidTerm["bad"] & HomeWorks["hardwork"] & ClassActivity["very lazy"] , Score["D"])
...
rule40 = ctrl.Rule(EndTerm['very good'] & MidTerm["normal"] & HomeWorks["hardwork"] & ClassActivity["very lazy"] , Score["C"])
...
rule44 = ctrl.Rule(EndTerm['very good'] & MidTerm["good"] & HomeWorks["hardwork"] & ClassActivity["very lazy"] , Score["C"])
rule45 = ctrl.Rule(EndTerm['bad'] & MidTerm["very good"] & HomeWorks["hardwork"] & ClassActivity["very lazy"] , Score["D"])
rule46 = ctrl.Rule(EndTerm['normal'] & MidTerm["very good"] & HomeWorks["hardwork"] & ClassActivity["very lazy"] , Score["C"])
rule47 = ctrl.Rule(EndTerm['good'] & MidTerm["very good"] & HomeWorks["hardwork"] & ClassActivity["very lazy"] , Score["C"])
rule48 = ctrl.Rule(EndTerm['very good'] & MidTerm["very good"] & HomeWorks["hardwork"] & ClassActivity["very lazy"] , Score["B"])
...
rule52 = ctrl.Rule(EndTerm['very good'] & MidTerm["bad"] & HomeWorks["lazy"] & ClassActivity["lazy"] , Score["D"])
...
rule56 = ctrl.Rule(EndTerm['very good'] & MidTerm["normal"] & HomeWorks["lazy"] & ClassActivity["lazy"] , Score["D"])
...
rule60 = ctrl.Rule(EndTerm['very good'] & MidTerm["good"] & HomeWorks["lazy"] & ClassActivity["lazy"] , Score["C"])
rule61 = ctrl.Rule(EndTerm['bad'] & MidTerm["very good"] & HomeWorks["lazy"] & ClassActivity["lazy"] , Score["D"])
rule62 = ctrl.Rule(EndTerm['normal'] & MidTerm["very good"] & HomeWorks["lazy"] & ClassActivity["lazy"] , Score["D"])
rule63 = ctrl.Rule(EndTerm['good'] & MidTerm["very good"] & HomeWorks["lazy"] & ClassActivity["lazy"] , Score["C"])
rule64 = ctrl.Rule(EndTerm['very good'] & MidTerm["very good"] & HomeWorks["lazy"] & ClassActivity["lazy"] , Score["C"])
...
rule68 = ctrl.Rule(EndTerm['very good'] & MidTerm["bad"] & HomeWorks["normal"] & ClassActivity["lazy"] , Score["D"])
...
rule72 = ctrl.Rule(EndTerm['very good'] & MidTerm["normal"] & HomeWorks["normal"] & ClassActivity["lazy"] , Score["C"])
...
rule76 = ctrl.Rule(EndTerm['very good'] & MidTerm["good"] & HomeWorks["normal"] & ClassActivity["lazy"] , Score["C"])
rule77 = ctrl.Rule(EndTerm['bad'] & MidTerm["very good"] & HomeWorks["normal"] & ClassActivity["lazy"] , Score["D"])
rule78 = ctrl.Rule(EndTerm['normal'] & MidTerm["very good"] & HomeWorks["normal"] & ClassActivity["lazy"] , Score["C"])
rule79 = ctrl.Rule(EndTerm['good'] & MidTerm["very good"] & HomeWorks["normal"] & ClassActivity["lazy"] , Score["C"])
rule80 = ctrl.Rule(EndTerm['very good'] & MidTerm["very good"] & HomeWorks["normal"] & ClassActivity["lazy"] , Score["B"])
...
rule84 = ctrl.Rule(EndTerm['very good'] & MidTerm["bad"] & HomeWorks["hardwork"] & ClassActivity["lazy"] , Score["C"])
...
rule88 = ctrl.Rule(EndTerm['very good'] & MidTerm["normal"] & HomeWorks["hardwork"] & ClassActivity["lazy"] , Score["C"])
...
rule92 = ctrl.Rule(EndTerm['very good'] & MidTerm["good"] & HomeWorks["hardwork"] & ClassActivity["lazy"] , Score["B"])
rule93 = ctrl.Rule(EndTerm['bad'] & MidTerm["very good"] & HomeWorks["hardwork"] & ClassActivity["lazy"] , Score["C"])
rule94 = ctrl.Rule(EndTerm['normal'] & MidTerm["very good"] & HomeWorks["hardwork"] & ClassActivity["lazy"] , Score["C"])
rule95 = ctrl.Rule(EndTerm['good'] & MidTerm["very good"] & HomeWorks["hardwork"] & ClassActivity["lazy"] , Score["B"])
rule96 = ctrl.Rule(EndTerm['very good'] & MidTerm["very good"] & HomeWorks["hardwork"] & ClassActivity["lazy"] , Score["B"])
...
rule100 = ctrl.Rule(EndTerm['very good'] & MidTerm["bad"] & HomeWorks["lazy"] & ClassActivity["normal"] , Score["D"])
...
rule104 = ctrl.Rule(EndTerm['very good'] & MidTerm["normal"] & HomeWorks["lazy"] & ClassActivity["normal"] , Score["C"])
...
rule108 = ctrl.Rule(EndTerm['very good'] & MidTerm["good"] & HomeWorks["lazy"] & ClassActivity["normal"] , Score["C"])
rule109 = ctrl.Rule(EndTerm['bad'] & MidTerm["very good"] & HomeWorks["lazy"] & ClassActivity["normal"] , Score["D"])
rule110 = ctrl.Rule(EndTerm['normal'] & MidTerm["very good"] & HomeWorks["lazy"] & ClassActivity["normal"] , Score["C"])
rule111 = ctrl.Rule(EndTerm['good'] & MidTerm["very good"] & HomeWorks["lazy"] & ClassActivity["normal"] , Score["C"])
rule112 = ctrl.Rule(EndTerm['very good'] & MidTerm["very good"] & HomeWorks["lazy"] & ClassActivity["normal"] , Score["B"])
...
rule116 = ctrl.Rule(EndTerm['very good'] & MidTerm["bad"] & HomeWorks["normal"] & ClassActivity["normal"] , Score["C"])
...
rule120 = ctrl.Rule(EndTerm['very good'] & MidTerm["normal"] & HomeWorks["normal"] & ClassActivity["normal"] , Score["C"])
...
rule124 = ctrl.Rule(EndTerm['very good'] & MidTerm["good"] & HomeWorks["normal"] & ClassActivity["normal"] , Score["B"])
rule125 = ctrl.Rule(EndTerm['bad'] & MidTerm["very good"] & HomeWorks["normal"] & ClassActivity["normal"] , Score["C"])
rule126 = ctrl.Rule(EndTerm['normal'] & MidTerm["very good"] & HomeWorks["normal"] & ClassActivity["normal"] , Score["C"])
rule127 = ctrl.Rule(EndTerm['good'] & MidTerm["very good"] & HomeWorks["normal"] & ClassActivity["normal"] , Score["B"])
rule128 = ctrl.Rule(EndTerm['very good'] & MidTerm["very good"] & HomeWorks["normal"] & ClassActivity["normal"] , Score["B"])
...
rule132 = ctrl.Rule(EndTerm['very good'] & MidTerm["bad"] & HomeWorks["hardwork"] & ClassActivity["normal"] , Score["C"])
...
rule136 = ctrl.Rule(EndTerm['very good'] & MidTerm["normal"] & HomeWorks["hardwork"] & ClassActivity["normal"] , Score["B"])
...
rule140 = ctrl.Rule(EndTerm['very good'] & MidTerm["good"] & HomeWorks["hardwork"] & ClassActivity["normal"] , Score["B"])
rule141 = ctrl.Rule(EndTerm['bad'] & MidTerm["very good"] & HomeWorks["hardwork"] & ClassActivity["normal"] , Score["C"])
rule142 = ctrl.Rule(EndTerm['normal'] & MidTerm["very good"] & HomeWorks["hardwork"] & ClassActivity["normal"] , Score["B"])
rule143 = ctrl.Rule(EndTerm['good'] & MidTerm["very good"] & HomeWorks["hardwork"] & ClassActivity["normal"] , Score["B"])
rule144 = ctrl.Rule(EndTerm['very good'] & MidTerm["very good"] & HomeWorks["hardwork"] & ClassActivity["normal"] , Score["A"])
...
rule148 = ctrl.Rule(EndTerm['very good'] & MidTerm["bad"] & HomeWorks["lazy"] & ClassActivity["hardwork"] , Score["C"])
...
rule152 = ctrl.Rule(EndTerm['very good'] & MidTerm["normal"] & HomeWorks["lazy"] & ClassActivity["hardwork"] , Score["C"])
...
rule156 = ctrl.Rule(EndTerm['very good'] & MidTerm["good"] & HomeWorks["lazy"] & ClassActivity["hardwork"] , Score["B"])
rule157 = ctrl.Rule(EndTerm['bad'] & MidTerm["very good"] & HomeWorks["lazy"] & ClassActivity["hardwork"] , Score["C"])
rule158 = ctrl.Rule(EndTerm['normal'] & MidTerm["very good"] & HomeWorks["lazy"] & ClassActivity["hardwork"] , Score["C"])
rule159 = ctrl.Rule(EndTerm['good'] & MidTerm["very good"] & HomeWorks["lazy"] & ClassActivity["hardwork"] , Score["B"])
rule160 = ctrl.Rule(EndTerm['very good'] & MidTerm["very good"] & HomeWorks["lazy"] & ClassActivity["hardwork"] , Score["B"])
...
rule164 = ctrl.Rule(EndTerm['very good'] & MidTerm["bad"] & HomeWorks["normal"] & ClassActivity["hardwork"] , Score["C"])
...
rule168 = ctrl.Rule(EndTerm['very good'] & MidTerm["normal"] & HomeWorks["normal"] & ClassActivity["hardwork"] , Score["B"])
...
rule172 = ctrl.Rule(EndTerm['very good'] & MidTerm["good"] & HomeWorks["normal"] & ClassActivity["hardwork"] , Score["B"])
rule173 = ctrl.Rule(EndTerm['bad'] & MidTerm["very good"] & HomeWorks["normal"] & ClassActivity["hardwork"] , Score["C"])
rule174 = ctrl.Rule(EndTerm['normal'] & MidTerm["very good"] & HomeWorks["normal"] & ClassActivity["hardwork"] , Score["B"])
rule175 = ctrl.Rule(EndTerm['good'] & MidTerm["very good"] & HomeWorks["normal"] & ClassActivity["hardwork"] , Score["B"])
rule176 = ctrl.Rule(EndTerm['very good'] & MidTerm["very good"] & HomeWorks["normal"] & ClassActivity["hardwork"] , Score["A"])
...
rule180 = ctrl.Rule(EndTerm['very good'] & MidTerm["bad"] & HomeWorks["hardwork"] & ClassActivity["hardwork"] , Score["B"])
...
rule184 = ctrl.Rule(EndTerm['very good'] & MidTerm["normal"] & HomeWorks["hardwork"] & ClassActivity["hardwork"] , Score["B"])
...
rule188 = ctrl.Rule(EndTerm['very good'] & MidTerm["good"] & HomeWorks["hardwork"] & ClassActivity["hardwork"] , Score["A"])
rule189 = ctrl.Rule(EndTerm['bad'] & MidTerm["very good"] & HomeWorks["hardwork"] & ClassActivity["hardwork"] , Score["A"])
rule190 = ctrl.Rule(EndTerm['normal'] & MidTerm["very good"] & HomeWorks["hardwork"] & ClassActivity["hardwork"] , Score["A"])
rule191 = ctrl.Rule(EndTerm['good'] & MidTerm["very good"] & HomeWorks["hardwork"] & ClassActivity["hardwork"] , Score["A"])
rule192 = ctrl.Rule(EndTerm['very good'] & MidTerm["very good"] & HomeWorks["hardwork"] & ClassActivity["hardwork"] , Score["A"])
...
Scoring.input['EndTerm'] = 11
Scoring.input['MidTerm'] = 19.9
Scoring.input['HomeWorks'] = 4.9
Scoring.input['ClassActivity'] = 99.9
...
while True: 
	answer = simpledialog.askinteger(title="Exit",
                           prompt="For Exit enter 1")
	if answer == 1: 
		break
